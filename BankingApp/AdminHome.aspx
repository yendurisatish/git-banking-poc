<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="BankingApp.AdminHome" %>
    ...
    <table style="font-family : Arial">
        ...
        <tr>
            ...
            <td style="height:500px;background-color:#E6E6E6;width:650px">
               ...
               <%-- <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="154px"   >
                    <Columns>
                ...
                <asp:GridView ID="AdminHomeGrid" runat="server" AutoGenerateColumns="true"></asp:GridView>
