<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aviewdeposits.aspx.cs" Inherits="BankingApp.Aviewdeposits" %>
    ...
    <table style="font-family : Arial">
        ...
        <tr>
            ...
            <td style="height:500px;background-color:#E6E6E6;width:650px">
                <h2>
                    View all deposits</h2>
                <asp:GridView ID="AviewDepositsGrid" runat="server"  AutoGenerateColumns="false" Height="154px">
                    <Columns>
